//
//  MainPageViewControllerOLD.swift
//  WeatherForecast
//
...
//class MainPageViewControllerOLD: UIViewController, UpdatableWithForecastData {
//    
...
//            MainPageCollectionViewCellOLD.self,
//            forCellWithReuseIdentifier: MainPageCollectionViewCellOLD.reuseIdentifier
//        )
//    }
//    
//    // MARK: Setup layout
...
//                    withReuseIdentifier: MainPageCollectionViewCellOLD.reuseIdentifier,
//                    for: indexPath
//                ) as? MainPageCollectionViewCellOLD else {
...
//    }
//    
////    private func fetchGeocodingData(withLatitude lat: Double, andLongitude lon: Double) {
////        NetworkManager.shared.fetchGeocodeData(forRequestType: .reverse(latitude: lat, longitude: lon))
////    }
//}
